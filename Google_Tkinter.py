...
equals = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="#0D98BA", cursor="hand2",
                command=lambda: bt_equal()).grid(row=4, column=3, padx=1, pady=1)

sin_f = Button(btns_frame, text="sin", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
               command=lambda: btn_click(".")).grid(row=5, column=0, padx=1, pady=1)
cos_f = Button(btns_frame, text="cos", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
               command=lambda: btn_click(".")).grid(row=5, column=1, padx=1, pady=1)
tan_f = Button(btns_frame, text="tan", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
               command=lambda: btn_click(".")).grid(row=5, column=2, padx=1, pady=1)
squar_f = Button(btns_frame, text="x*x", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
